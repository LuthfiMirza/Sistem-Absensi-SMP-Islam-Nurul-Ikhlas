    ...
    public function bulkCheckedDelete()
    {
        if (auth()->check()) {
            ...
            try {
                ...
                $this->dispatchBrowserEvent('showToast', ['success' => true, 'message' => 'Data Guru/Karyawan berhasil dihapus.']);
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Nama Lengkap', 'name', 'users.name')
                ->searchable()
                ->makeInputText()
                ->editOnClick()
                ->sortable(),
            ...
            Column::make('No. Telepon', 'phone', 'users.phone')
                ->searchable()
                ->makeInputText()
                ->sortable(),

            Column::make('Divisi/Mata Pelajaran', 'position', 'positions.name')
                ->searchable()
                ->makeInputMultiSelect(Position::all(), 'name', 'position_id')
                ->sortable(),

            Column::make('Status', 'role', 'roles.name')
                ->searchable()
